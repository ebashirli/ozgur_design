function Cta() {
  return (
    <div className="text-center bg-[#F6F8F7] py-10 text-[#292E3D]">
      ...
      <form>
        <div className="grid grid-cols-2 gap-x-8 gap-y-5 px-[25%] py-1">
          ...
          <div className="col-start-1 col-end-3">
            <input
              className="bg-[#2947A9] text-white text-xl font-bold w-1/2"
              type="submit"
              value="Submit"
            />
          </div>
